...
public class ALUDic {
	...
	public static final VendorDicEntry LR_Section_OC1_STS1_and_RS_STM0 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 19,
			DicConst.LR_Section_OC1_STS1_and_RS_STM0);
	public static final VendorDicEntry LR_Section_OC3_STS3_and_RS_STM1 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 20,
			DicConst.LR_Section_OC3_STS3_and_RS_STM1);
	public static final VendorDicEntry LR_Section_OC12_STS12_and_RS_STM4 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 21,
			DicConst.LR_Section_OC12_STS12_and_RS_STM4);
	public static final VendorDicEntry LR_Section_OC48_STS48_and_RS_STM16 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 22,
			DicConst.LR_Section_OC48_STS48_and_RS_STM16);
	public static final VendorDicEntry LR_Section_OC192_STS192_and_RS_STM64 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 23,
			DicConst.LR_Section_OC192_STS192_and_RS_STM64);
	...
	public static final VendorDicEntry LR_Line_OC48_STS48_and_MS_STM16 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 27,
			DicConst.LR_Line_OC48_STS48_and_MS_STM16);
	public static final VendorDicEntry LR_Line_OC192_STS192_and_MS_STM64 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 28,
			DicConst.LR_Line_OC192_STS192_and_MS_STM64);
	...
	public static final VendorDicEntry LR_Optical_Transmission_Section = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 42,
			DicConst.LR_Optical_Transmission_Section);
	...
	public static final VendorDicEntry LR_Section_OC24_STS24_and_RS_STM8 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 88,
			DicConst.LR_Section_OC24_STS24_and_RS_STM8);
	...
	public static final VendorDicEntry LR_Section_OC768_STS768_and_RS_STM256 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 90,
			DicConst.LR_Section_OC768_STS768_and_RS_STM256);
	public static final VendorDicEntry LR_Line_OC768_STS768_and_MS_STM256 = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 91,
			DicConst.LR_Line_OC768_STS768_and_MS_STM256);

	public static final VendorDicEntry LR_T_MPLS_SECTION = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 1000, DicConst.LR_T_MPLS_SECTION);
	public static final VendorDicEntry LR_T_MPLS_PATH = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 1001, DicConst.LR_T_MPLS_PATH);
	public static final VendorDicEntry LR_T_MPLS_CHANNEL = new VendorDicEntry(DicConst.DIC_LAYER_RATE, 1002, DicConst.LR_T_MPLS_CHANNEL);

	public static int getMappedValue(String type, int vendorValue) {
		Field[] declaredFields = ALUDic.class.getDeclaredFields();
		for (int i = 0; i < declaredFields.length; i++) {
			try {
				Field declaredField = declaredFields[i];
				Object value = declaredField.get(ALUDic.class);
