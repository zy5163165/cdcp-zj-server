 ...
 */
public class FHDwdmUtil {
    private Log logger = LogFactory.getLog(getClass());
    public static boolean isOMSRate(String rate) {
        if (rate == null) return false;
        return rate.equals(FHDic.LR_Optical_Multiplex_Section.value+"")
                || rate.startsWith(FHDic.LR_Optical_Multiplex_Section.value + "||")
                || rate.endsWith("||" + FHDic.LR_Optical_Multiplex_Section.value)
                || rate.contains("||" + FHDic.LR_Optical_Multiplex_Section.value +"||")
