...
public class CPW extends CdcpObject
{
	...
	private String apwid = "";
	private String zpwid = "";
	private String aWorkingMode= "";
	...
	public String getApwid() {
		return apwid;
	}

	public void setApwid(String apwid) {
		this.apwid = apwid;
	}
	...
	public String getaWorkingMode() {
		return aWorkingMode;
	}

	public void setaWorkingMode(String aWorkingMode) {
		this.aWorkingMode = aWorkingMode;
	}
